...
import { createPurchase } from '@faker/purchase.faker';
...
describe('PurchaseController (e2e) [POST]', () => {
  ...
  describe('POST Purchase', () => {
    it('/ should create a purchase, return 201 with admin user', async () => {
    ...
    it('/ should not create a purchase, return 401 with invalid api key', async () => {
      const newPurchase = createPurchase();
      const dto: CreatePurchaseDto = {
        ...newPurchase,
        supplier: supplier.id,
    ...
    it('/ should not create a purchase, return 401 if api key is missing', async () => {
      const newPurchase = createPurchase();
      const dto: CreatePurchaseDto = {
        ...newPurchase,
        supplier: supplier.id,
